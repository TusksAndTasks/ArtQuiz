...
function createSlots(category, number){
    ...
    for (let i = 0; i < 10; i++){
        container.innerHTML = container.innerHTML + `<img src="./img/${firstPictureNumber + i}.jpg" alt="first-picture" width="260" height="260" class="score-result non-answered">`
    }
...
function showResults(number){
    ...
    pictures.forEach(function(picture){
        if(localStorage.getItem(`${answerNumber}`) != null && localStorage.getItem(`${answerNumber}`) === 'true'){
